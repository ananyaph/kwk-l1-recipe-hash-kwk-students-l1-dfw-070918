...
puts "You have saved #{new_savings} dollars for a rainy day"
end

puts "Do you want to purchase anything? We can tell you if you can afford it this month."
answer = gets.chomp
...
if long_term_savings != 0
  if splurge_money - price > 0 
    puts "You can buy it! "
  else  
    puts "Sorry, maybe next month!"
  end
end

if new_savings != 0 
  if splurge_new - price > 0
    puts "You can buy it! "
  else  
    puts "Sorry, maybe next month!"
  end
